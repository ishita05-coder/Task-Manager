      ...
      <main className="flex-1 overflow-y-auto w-full">
        <div className="p-4 md:p-8 max-w-6xl mx-auto">
          ...
          <div className="glass-card glass-card-dark rounded-2xl animate-fade-in-up" style={{ animationDelay: '700ms' }}>
            <div className="p-6 border-b border-gray-200/50 flex flex-col md:flex-row md:justify-between md:items-center gap-4">
              <h3 className="text-xl font-extrabold text-gray-900">Recent Tasks</h3>
              <div className="relative w-full md:w-auto">
                ...
                <input 
                  ...
                  className="w-full md:w-72 pl-10 pr-4 py-3 border-2 border-gray-100 rounded-xl focus:ring-4 focus:ring-pink-500/20 focus:border-pink-500 outline-none transition-all font-medium text-gray-900 bg-white/50 focus:bg-white"
                />
              </div>
            </div>
